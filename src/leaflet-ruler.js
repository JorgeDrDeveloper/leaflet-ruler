(function (factory, window) {
  ...
  L.Control.Ruler = L.Control.extend({
      ...
      if (this._clickCount > 0 && !e.latlng.equals(this._clickedPoints[this._clickedPoints.length - 2])) {
        ...
        if (this._clickCount > 1) {
          text = '<b>' + this.options.angleUnit.label + '</b>&nbsp;'
            ...
            + this.options.angleUnit.display + '<br><b>'
            + this.options.lengthUnit.label + '</b>&nbsp;'
    ...
    _moving: function (e) {
      this._map._container.tabIndex = 0;
      ...
      if (this._clickedLatLong) {
        ...
        if (this._clickCount > 1) {
          text = '<b>' + this.options.angleUnit.label + '</b>&nbsp;'
            ...
            + this.options.lengthUnit.display + '<br><div class="plus-length">(+'
            + this._result.Distance.toFixed(this.options.lengthUnit.decimal) + ')</div>';
        }
        else {
          text = '<b>' + this.options.angleUnit.label + '</b>&nbsp;'
            + this._result.Bearing.toFixed(this.options.angleUnit.decimal) + '&nbsp;'
